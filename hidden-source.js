(function() {
  ...
  function showFallbackUI() {
    ...
    overlay.style.cssText = 'position: fixed; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0, 0, 0, 0.9); display: flex; flex-direction: column; align-items: center; justify-content: center; z-index: 9999; padding: 20px; text-align: center; color: white;';
    
    overlay.innerHTML = '<p style="margin-bottom: 20px; font-size: 16px;">We couldn\'t open the link automatically. Please tap the button below to open it in Safari.</p><a href="' + targetUrl + '" style="padding: 12px 24px; background: #0070f3; color: #fff; border-radius: 8px; text-decoration: none; font-size: 16px; font-weight: bold;">Open in Safari</a>';
